...
I changed Gemfile omitting versions of some gems and using Rails 5.1, because my computer did not run correctly, I had problems with versions of gems and
libraries in my GNU/Linux S.O.
